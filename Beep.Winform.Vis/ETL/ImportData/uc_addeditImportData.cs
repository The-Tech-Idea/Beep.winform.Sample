...
{
    [AddinAttribute(Caption = "Add/Edit import Data", Name = "uc_addeditImportData", misc = "Import", menu = "Import", addinType = AddinType.Control, displayType = DisplayType.InControl)]
