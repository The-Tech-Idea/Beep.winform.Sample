    ...
    public partial class uc_webapiQueryParameters : UserControl,IDM_Addin
    {
       ...
       // public event EventHandler<PassedArgs> OnObjectSelected;
        ...
        public void SetConfig(IDMEEditor pbl, IDMLogger plogger, IUtil putil, string[] args, IPassedArgs e, IErrorsInfo per)
        {
            ...
            uc_bindingNavigator1.bindingSource = entitiesBindingSource;
            uc_bindingNavigator1.SaveCalled += Uc_bindingNavigator1_SaveCalled;
            uc_bindingNavigator2.bindingSource = paramentersBindingSource;
            ...
            uc_bindingNavigator2.HightlightColor = Color.Yellow;
