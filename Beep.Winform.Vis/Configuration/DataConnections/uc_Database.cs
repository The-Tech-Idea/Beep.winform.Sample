...
{
    [AddinAttribute(Caption = "RDBMS DataConnection ", Name = "uc_Database", misc = "Config", menu = "Configuration", displayType = DisplayType.Popup, addinType = AddinType.Control)]
      public partial class uc_Database : UserControl, IDM_Addin
    {
        public uc_Database()
        {
            InitializeComponent();
