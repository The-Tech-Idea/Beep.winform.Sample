...
{
    [AddinAttribute(Caption = "File DataConnection ", Name = "uc_File", misc = "Config", menu = "Configuration", displayType = DisplayType.Popup, addinType = AddinType.Control)]
    public partial class uc_File : UserControl, IDM_Addin
    {
        public uc_File()
        {
            InitializeComponent();
        ...
        public void Run(IPassedArgs pPassedarg)
        {
            if (DBWork != null)
            {
                ...
                if (IsNew)
                {
                    ...
                    cn.Category = DatasourceCategory.FILE;
                    DBWork.Create(cn);
                }
                else
                {
