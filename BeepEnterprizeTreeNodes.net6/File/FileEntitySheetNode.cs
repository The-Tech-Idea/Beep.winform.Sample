...
namespace  BeepEnterprize.Vis.Module
{
    public class FileEntitySheetNode : IBranch 
    {
       ...
       // public event EventHandler<PassedArgs> ActionNeeded;
        ...
        [CommandAttribute(Caption = "View Structure", Hidden = false, DoubleClick = true, iconimage = "structure.ico")]
        ...
        [CommandAttribute(Caption = "Show", Hidden = false,  DoubleClick =true, iconimage = "edit.ico")]
