...
namespace  BeepEnterprize.Vis.Module
{
    public class ConfigCategoryNode  : IBranch 
    {
        ...
        public ConfigCategoryNode(ITree pTreeEditor, IDMEEditor pDMEEditor, IBranch pParentNode, string pBranchText, int pID, EnumPointType pBranchType, string pimagename)
        {
